---
mmh3_hash: "9b20e9e829899bee6b9c34c1409ee6be"
title: "展示"
...
<Card title="代理 UI" icon="window-maximize" href="https://releaseflow.net/kitze/agents-ui">
  **@kitze** • `ui` `skills` `sync`

  桌面应用,用于管理 Agents、Claude、Codex 和 OpenClaw 的技能/命令。

  <img src="/assets/showcase/agents-ui.jpg" alt="代理 UI 应用" />
</Card>
...
<Card title="Kev 的梦之队(14+ 代理)" icon="robot" href="https://github.com/adam91holt/orchestrated-ai-articles">
  **@adam91holt** • `multi-agent` `orchestration` `architecture` `manifesto`
  ...
  在一个网关下有 14 个以上的代理,Opus 4.5 编排器委托给 Codex 工作者。全面的[技术文章](https://github.com/adam91holt/orchestrated-ai-articles)涵盖梦之队名单、模型选择、沙盒、webhooks、心跳和委托流程。代理沙盒的 [Clawdspace](https://github.com/adam91holt/clawdspace)。[博客文章](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/)。
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli` `issues`

  与代理工作流程(Claude Code、OpenClaw)集成的 Linear CLI。从终端管理问题、项目和工作流程。第一个外部 PR 合并!
</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli` `automation`

  通过 Beeper Desktop 阅读、发送和归档消息。使用 Beeper 本地 MCP API,以便代理可以在一个地方管理所有聊天(iMessage、WhatsApp 等)。
</Card>
...
<Card title="Clawdia 电话桥" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi 语音助手 ↔ OpenClaw HTTP 桥。与您的代理进行近实时电话呼叫。
</Card>
