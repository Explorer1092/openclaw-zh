---
mmh3_hash: "78da244abf8bac6e063e746b8dd91147"
title: "卸载"
sidebarTitle: "卸载"
...
两条路径：
- 如果 `openclaw` 仍然安装，选择 **简单路径**。
- 如果 CLI 已消失但服务仍在运行，选择 **手动服务移除**。
...
如果网关服务继续运行但 `openclaw` 丢失，请使用此方法。
...
如果你使用了配置文件，请将标签和 plist 名称替换为 `ai.openclaw.<profile>`。如果存在，请删除任何旧版 `com.openclaw.*` plist。
