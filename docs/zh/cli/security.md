...
mmh3_hash: "0fa062421a74286d83e1df5ffafa4f78"
...
当多个 DM 发件人共享主Session时,审计会发出警告,并建议对共享收件箱使用 `session.dmScope="per-channel-peer"`(或对多账户Channel使用 `per-account-channel-peer`)。
