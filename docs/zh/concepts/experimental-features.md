---
mmh3_hash: "8c782014717f93d437c07c9265e545e5"
title: "实验性功能"
...
| 结构化规划工具       | `tools.experimental.planTool`                             | 您希望在兼容的运行时和 UI 中为多步骤工作跟踪公开结构化的 `update_plan` 工具                        | [Gateway 配置参考](/gateway/config-tools#toolsexperimental)                                   |
