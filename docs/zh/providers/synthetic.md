...
mmh3_hash: "7e4f9ef0ca7eddf9f540163ac1120781"
...
Synthetic 公开 Anthropic 兼容的端点。OpenClaw 将其注册为 `synthetic` Provider，并使用 Anthropic Messages API。
...
注意：OpenClaw 的 Anthropic 客户端将 `/v1` 附加到 Base URL，因此请使用
...
- 有关 Provider 规则，请参见[模型 Provider](/concepts/model-providers)。
